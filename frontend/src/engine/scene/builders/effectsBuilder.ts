import { Color3, Color4, ParticleSystem, Scene, Sprite, SpriteManager, Texture, Vector3 } from "@babylonjs/core";
...
// 	emitter.position = new Vector3(20, 10, 0);
...
// 	new LensFlare(0.22,  0.05, new Color3(1, 0.95, 0.8), texture, lensFlareSystem);
// 	new LensFlare(0.15, 0.0, new Color3(0.6, 0.8, 1), texture, lensFlareSystem);
// 	new LensFlare(0.1, -0.1, new Color3(0.61, 0.3, 0.86), texture, lensFlareSystem);
// 	new LensFlare(0.08, -0.2, new Color3(1, 0.9, 0.6), texture, lensFlareSystem);
